          ...
          <div className="relative bg-slate-900/50 backdrop-blur-xl border border-cyan-500/30 p-8 rounded-2xl shadow-2xl shadow-cyan-500/10 overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                <div key={i} className="bg-slate-800/50 backdrop-blur-xl border border-cyan-500/20 rounded-xl p-6 hover: border-cyan-500/40 transition-all duration-300">
                  <h4 className="text-lg font-medium mb-3 text-cyan-400">
                    {item.title}
                  </h4>
          ...
          <div className="relative bg-slate-900/50 backdrop-blur-xl border border-cyan-500/30 p-8 rounded-2xl shadow-2xl shadow-cyan-500/10 overflow-hidden">
            ...
            <div className="space-y-5">
              {[
                ...
                { icon: null, title: "Modern UI Design", desc: "Completely redesigned interface with Tron-inspired aesthetics, smooth animations, and improved user experience across all platforms." }
              ].map((feature, i) => (
                <div key={i} className="bg-slate-800/50 backdrop-blur-xl border border-cyan-500/20 rounded-xl p-6 hover:border-cyan-500/40 transition-all duration-300">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-xl flex items-center justify-center flex-shrink-0 border border-cyan-500/30">
                      {feature.icon ? (
