...
# NetherStatus Discord Bot

The **NetherStatus** bot monitors your Minecraft servers and posts live status updates directly in your Discord server. Player counts, online/offline state, version, and MOTD are all updated automatically.
